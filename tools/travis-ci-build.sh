...
if [ "$TRAVIS_PULL_REQUEST" = "false" ]; then
	...
	dotnet ./tools/sonar/SonarScanner.MSBuild.dll begin /o:"c1gdoyle" /k:"c1gdoyle_Dunk.Tools.Foundation" /d:sonar.cs.vstest.reportsPaths="**/TestResults/*.trx" /d:sonar.cs.opencover.reportsPaths="*/coverage.opencover.xml" /d:sonar.host.url="https://sonarcloud.io" /d:sonar.verbose=false /d:sonar.login=${SONAR_TOKEN}
fi
