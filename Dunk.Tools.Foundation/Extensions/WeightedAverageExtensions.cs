...
namespace Dunk.Tools.Foundation.Extensions
{
    ...
    public static class WeightedAverageExtensions
    {
        ...
        /// <returns>
        /// The weighted-average, if <paramref name="sequence"/> are empty or total weight is 0 then returns <see cref="double.NaN"/>.
        /// </returns>
        ...
        public static double? WeightedAverage<T>(this IEnumerable<T> sequence, Func<T, decimal?> valueSelector, Func<T, decimal?> weightSelector)
        {
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="sequence"/>, <paramref name="valueSelector"/> or <paramref name="weightSelector"/> was null.</exception>
        public static double? WeightedAverage<T>(this IEnumerable<T> sequence, Func<T, float?> valueSelector, Func<T, float?> weightSelector)
        {
            sequence.ThrowIfNull(nameof(sequence));
            valueSelector.ThrowIfNull(nameof(valueSelector));
            weightSelector.ThrowIfNull(nameof(weightSelector));
